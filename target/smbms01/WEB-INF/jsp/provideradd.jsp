...
<div class="right">
        ...
        <div class="providerAdd">
           <form id="providerForm" name="providerForm" method="post" action="${pageContext.request.contextPath }/provider/doaddpro">
			<input type="hidden" name="method" value="add">
                ...
                <div class="providerAddBtn">
                    ...
                    <input type="button" name="add" id="add1" value="保存">
