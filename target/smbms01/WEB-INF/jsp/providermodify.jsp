...
<%@include file="common/head.jsp"%>
  ...
  <div class="right">
      ...
      <div class="providerAdd">
          <form id="providerForm" name="providerForm" method="post" action="${pageContext.request.contextPath }/provider/doupprovider">
...
<script type="text/javascript" src="${pageContext.request.contextPath }/statics/js/zprovidermodify.js"></script>