...
<!--时间-->
 ...
 <section class="publicMian ">
     <div class="left">
         ...
         <nav>
             <ul class="list">
                 <li ><a href="${pageContext.request.contextPath }/bill/tobill">订单管理</a></li>
              <li><a href="${pageContext.request.contextPath }/provider/toProView">供应商管理</a></li>
              <li><a href="${pageContext.request.contextPath }/user/userList.html">用户管理</a></li>
              <li><a href="${pageContext.request.contextPath }/user/upPwd">密码修改</a></li>
