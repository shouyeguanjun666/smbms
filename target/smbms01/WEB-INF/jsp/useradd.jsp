...
<div class="right">
        ...
        <div class="providerAdd">
            <form enctype="multipart/form-data" id="userForm" name="userForm" method="post" action="${pageContext.request.contextPath }/user/saveuser">
                ...
                <div>
					...
					<!-- 放置提示信息 -->
					<font id="codemess" color="red">123</font>
                </div>
                <div>
