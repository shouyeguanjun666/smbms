...
function deleteProvider(obj){
	...
	$.post(path+"/provider/delPro","id="+obj.attr("proid"),function (data) {
...
$(function(){
	$(".viewProvider").on("click",function(){
		...
		var obj = $(this);
		window.location.href=path+"/provider/viewProvider?id="+ obj.attr("proid");
	});
	
	$(".modifyProvider").on("click",function(){
		var obj = $(this);
		window.location.href=path+"/provider/upProvider?id="+ obj.attr("proid");
	});
